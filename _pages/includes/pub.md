...
*OccamVTS: Distilling Vision Models to 1\% Parameters for Time Series Forecasting* (under review)\\
...
- ``AAAI 2026`` Weilin Ruan, Xilin Dang, Ziyu Zhou, **Sisuo LYU**, Yuxuan Liang, "*Retrieval Augmented Spatio-Temporal Framework for Traffic Prediction*" (under review)
